            ...
            ! function() {
                ...
                var s = document.getElementById("barChart"),
                    s = (s && new Chart(s, {
                        type: "bar",
                        data: {
                            labels: ["7/12", "8/12", "9/12", "10/12", "11/12", "12/12", "13/12", "14/12",
                ...
                s && new Chart(s, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            data: [80, 150, 180, 270, 210, 160, 160, 202, 265, 210, 270, 255, 290,
                                360, 375
                            ],
                            label: "Europe",
                            ...
                            data: [80, 99, 82, 90, 115, 115, 74, 75, 130, 155, 125, 90, 140, 130,
                                180
                            ],
                            label: "Africa",
                            borderColor: r,
                ...
                if (c) {
                    const p = c.getContext("2d").createLinearGradient(0, 0, 0, 150),
                        b = (p.addColorStop(0, "rgba(85, 85, 255, 0.9)"), p.addColorStop(1,
                            "rgba(151, 135, 255, 0.8)"), c.getContext("2d").createLinearGradient(0, 0, 0, 150));
                ...
                s && new Chart(s, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            label: "Asia",
                            data: [70, 85, 75, 150, 100, 140, 110, 105, 160, 150, 125, 190, 200,
                                240, 275
                            ],
                            tension: 0,
                            fill: !0,
                            ...
                            label: "Europe",
                            data: [240, 195, 160, 215, 185, 215, 185, 200, 250, 210, 195, 250, 235,
                                300, 315
                            ],
                            tension: 0,
                            fill: !0,
