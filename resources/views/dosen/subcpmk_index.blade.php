                                    ...
                                    <td align="center">
                                        <div class='btn-group' role='group' aria-label='Action'>
                                            ...
                                            <a role='button' class='btn btn-icon btn-danger del-btn'
                                                href='{{ route('dosen.subcpmk.delete', $c->subcpmk_id) }}'
    ...
    <div class="modal fade" id="addSubCPMK" tabindex="-1" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('dosen.subcpmk.store') }}" method="post" class="needs-validation">
                    @csrf
        ...
        <div class="modal fade" id="editSubCPMK{{ $c->subcpmk_id }}" tabindex="-1" style="display: none;"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('dosen.subcpmk.update', $c->subcpmk_id) }}" method="post"
                                ...
                                <div class="col mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" placeholder="contoh: 1"
                                            ...
                                            name="subcpmk_kode" value="{{ substr($c->subcpmk_kode, 2) }}" required>
                                        <div class="invalid-feedback">Wajib Diisi !</div>
                                    </div>
                                </div>
                            </div>
